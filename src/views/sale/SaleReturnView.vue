...
import { getAllSaleReturn, getAllSale, createSaleReturn } from '../../network/sale'
export default {
  name: 'SaleReturnView',
  components: {
    Layout,
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          this.saleReturnForm.operator = null
          this.saleReturnForm.returnsAmount = null
          ...
          this.saleReturnForm.saleReturnsSheetContent.forEach(item => {
            ...
            item.unitPrice = null
            item.returnsPrice = null
            item.returnsAmount = null
